...
async def start(b, m):
    ...
    await StreamBot.send_photo(
        chat_id=m.chat.id,
        photo ="https://graph.org/file/dc0c53f73304fdcf8858a.jpg",
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ Owner", url="https://t.me/TG_Movies4u")],
                [InlineKeyboardButton("💥 Source Code", url="https://t.me/TG_Movies4u")]
            ]
        )
    )
